//Main-->fetchcpu<-->getallhosts
//          >>comparehosts>>createVM / add new host
...
public class DRS1 
{
    ...
    public DRS1()
    {
    	try
    	{
			this.si=new ServiceInstance(new URL("https://130.65.133.74/sdk"),
